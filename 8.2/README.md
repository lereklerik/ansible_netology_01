...
* С прошлого задания хотела работать с контейнерами на образе `pycontribs/ubuntu`. И на самом деле потратила на это много времени. Но контейнеры с `ssh` так и не подружила.
